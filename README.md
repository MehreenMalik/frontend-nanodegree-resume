...
* **js/resumeBuilder.js**: Contains javascript objects.
...
2. It Iterates through each javaScript object and appends its information to index.html in the correct section.
